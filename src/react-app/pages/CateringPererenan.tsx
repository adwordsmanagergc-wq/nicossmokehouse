...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border-b border-amber-800/30">
      <SEO path="/catering-pererenan" title="BBQ Catering Pererenan | Villa & Event Catering | Nico's Smokehouse" description="BBQ catering in Pererenan, Bali — slow-smoked Texas BBQ, Caribbean and Peri Peri delivered straight to your villa or event. Book Nico's Smokehouse today." />

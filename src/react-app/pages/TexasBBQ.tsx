...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border-b border-amber-800/30">
      <SEO path="/texas-bbq-canggu-bali" title="Texas BBQ in Canggu, Bali | Nico's Smokehouse" description="Real Texas-style smoked BBQ in Canggu — US Prime brisket smoked 14+ hours, pork ribs, beef ribs and pulled pork. The only authentic Texas smokehouse in Bali." />
      <button

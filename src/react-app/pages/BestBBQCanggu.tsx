...
export default function BestBBQCanggu() {
  ...
  return (
    <div className="min-h-screen bg-stone-950 text-stone-100">
      <SEO path="/best-bbq-canggu" title="Best BBQ Restaurant in Canggu, Bali | Nico's Smokehouse" description="Nico's Smokehouse is the best BBQ in Canggu, Bali — Texas brisket smoked 14+ hours, jerk chicken, ribs and Peri Peri. Air-conditioned dining and BBQ catering across Bali." />
      {/* Hero Section */}

...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO path="/" title="Nico's Smokehouse | BBQ & Caribbean Restaurant in Canggu, Bali | Texas BBQ, Jerk Chicken & Peri Peri" description="Authentic Texas BBQ, Jamaican jerk chicken and Peri Peri at Nico's Smokehouse — Canggu's air-conditioned BBQ restaurant. Open daily 12pm–midnight. Book online or order delivery." />
      {/* Hero Section */}

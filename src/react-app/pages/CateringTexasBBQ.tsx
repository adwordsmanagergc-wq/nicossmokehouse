...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border-b border-amber-800/30">
      <SEO path="/texas-bbq-catering-bali" title="Texas BBQ Catering Bali | Brisket & Ribs Catering | Nico's Smokehouse" description="Authentic Texas BBQ catering in Bali. Slow-smoked brisket, beef ribs and pulled pork delivered to your villa or event. Catering for groups across Bali." />
      <button

...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border-b border-amber-800/30">
      <SEO path="/catering-uluwatu" title="BBQ Catering Uluwatu | Villa & Wedding Catering | Nico's Smokehouse" description="Premium BBQ catering in Uluwatu, Bali. Slow-smoked brisket, jerk chicken and Peri Peri delivered to your clifftop villa or wedding." />

...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border-b border-amber-800/30">
      <SEO path="/caribbean-catering-bali" title="Caribbean Catering Bali | Jerk Chicken & Curry Goat | Nico's Smokehouse" description="Authentic Caribbean catering in Bali — jerk chicken, curry goat, oxtail and rice & peas. Bring real Jamaican soul food to your villa or event." />
      <button

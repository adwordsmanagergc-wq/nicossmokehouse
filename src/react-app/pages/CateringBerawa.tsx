...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border-b border-amber-800/30">
      <SEO path="/catering-berawa" title="BBQ Catering Berawa | Villa & Event Catering | Nico's Smokehouse" description="BBQ catering in Berawa, Canggu — slow-smoked brisket, Caribbean dishes and Peri Peri chicken catered for villas, parties and weddings." />

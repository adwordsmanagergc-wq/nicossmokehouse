...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border-b border-amber-800/30">
      <SEO path="/catering-bali" title="BBQ Catering Bali | Villa, Wedding & Event Catering | Nico's Smokehouse" description="Premium BBQ catering across Bali — villas, weddings, birthdays and corporate events. Texas BBQ, Caribbean and Peri Peri delivered to Canggu, Seminyak, Uluwatu & beyond." />
      <button

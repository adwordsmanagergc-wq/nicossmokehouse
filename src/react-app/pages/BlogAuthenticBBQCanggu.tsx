...
export default function BlogAuthenticBBQCanggu() {
  ...
  return (
    ...
    >
      <SEO
        path="/blog/where-to-get-authentic-bbq-in-canggu-bali"
        title="Where to Get Authentic BBQ in Canggu, Bali | Nico's Smokehouse"
        description="The complete guide to authentic BBQ in Canggu — what to order, what to look for, and why Nico's Smokehouse leads the way for real wood-smoked Texas BBQ in Bali."
        type="article"
        schema={{
          "@context": "https://schema.org",
          "@type": "Article",
          headline: "Where to Get Authentic BBQ in Canggu, Bali",
          description:
            "The complete guide to authentic BBQ in Canggu — what to order, what to look for, and why Nico's Smokehouse leads the way for real wood-smoked Texas BBQ in Bali.",
          image:
          ...
          mainEntityOfPage: {
            "@type": "WebPage",
            "@id":
              "https://nicossmokehouse.com/blog/where-to-get-authentic-bbq-in-canggu-bali",
          },
        }}
      />

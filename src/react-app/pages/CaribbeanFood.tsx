...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border-b border-amber-800/30">
      <SEO path="/caribbean-food-canggu-bali" title="Caribbean & Jamaican Food in Canggu, Bali | Nico's Smokehouse" description="Authentic jerk chicken, curry goat, oxtail and rice & peas in Canggu. The only Caribbean restaurant in Bali serving real Jamaican soul food. Open daily, AC dining." />
      <button

...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border-b border-amber-800/30">
      <SEO path="/catering-canggu" title="BBQ Catering Canggu | Villa & Event Catering | Nico's Smokehouse" description="BBQ catering for villas, birthdays and weddings in Canggu. Texas BBQ, Caribbean and Peri Peri delivered to Berawa, Batu Bolong, Pererenan and beyond." />
      <button

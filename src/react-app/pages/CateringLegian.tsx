...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border-b border-amber-800/30">
      <SEO path="/catering-legian" title="BBQ Catering Legian | Villa & Event Catering | Nico's Smokehouse" description="BBQ catering in Legian — Texas-style smoked meats, jerk chicken and Peri Peri delivered to your villa, party or event in Bali." />

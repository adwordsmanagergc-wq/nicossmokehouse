...
export default function NotFoundPage() {
  return (
    <div className="min-h-screen flex items-center justify-center relative">
      <SEO path="/404" title="Page Not Found | Nico's Smokehouse Canggu, Bali" description="The page you're looking for doesn't exist. Head back to Nico's Smokehouse — Canggu's BBQ & Caribbean restaurant." noindex />

...
export default function Blog() {
  ...
  return (
    ...
    >
      <SEO path="/blog" title="Nico's Smokehouse Blog | BBQ & Caribbean in Canggu, Bali" description="Stories, guides and news from Nico's Smokehouse — the best BBQ restaurant in Canggu. Texas BBQ, Caribbean cuisine and Peri Peri in Bali." />

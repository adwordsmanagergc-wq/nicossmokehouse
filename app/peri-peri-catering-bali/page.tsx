...
import { periPeriCatering as page } from "@/lib/catering/peri-peri";
...
export default function PeriPeriCateringPage() {
  return (
    <>
      <script
      ...
      <main>
        ...
        <section className="bg-smoke px-4 py-12">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <SuburbSelector cuisineName="Peri Peri" />
          </Reveal>
        </section>
